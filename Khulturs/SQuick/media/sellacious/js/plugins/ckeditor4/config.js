 ...
 *
 * We're not using this file for configuration, it will be set on plugin.js
 */

CKEDITOR.editorConfig = function( config ) {
	config.extraPlugins = 'image2,embed,autoembed';
