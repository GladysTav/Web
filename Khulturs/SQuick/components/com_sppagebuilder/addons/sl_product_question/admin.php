...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'category'   => 'Sellacious',
		'addon_name' => 'sp_sl_product_question',
		'title'      => JText::_('Product Ask  Question'),
		'desc'       => JText::_('Sellacious Product Ask Question'),
		'attr'       => array(
			...
			'sellacious' => array(
				...
				'ask_title' => array(
					...
					'std'   => JText::_('Ask Question'),
				),

				'show_questions_list' => array(
					'type'   => 'select',
					'title'  => JText::_('Show Questions List'),
					'values' => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
