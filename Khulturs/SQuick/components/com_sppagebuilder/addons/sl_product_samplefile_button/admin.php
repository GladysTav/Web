...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'addon_name' => 'sp_sl_product_samplefile_button',
		'category'   => 'Sellacious',
		'title'      => JText::_('Product Sample File Button'),
		'desc'       => JText::_('Sellacious Product Sample File Button'),
		'attr'       => array(
			'general' => array(
			...
			'sellacious' => array(
				...
				'separator_samplefile_btn'=>array(
					'type'=>'separator',
					'title'=>JText::_('Sample File Button Options'),
				),
				'samplefile_btn_text' => array(
					'type'  => 'text',
					'title' => JText::_('Sample File button Text'),
					'desc'  => JText::_('Put here your desirable text'),
					'std'   => 'Download Sample File',
				),
				'samplefile_btn_fontstyle'=>array(
					'type'=>'select',
					...
					'multiple'=>true,
					'std'=>'',
					'depends' => array(array('samplefile_btn_text', '!=', '')),
				),
				'samplefile_btn_letterspace'=>array(
					'type'=>'select',
				...
				'samplefile_btn_appearance'=>array(
					'type'=>'select',
				...
				'samplefile_btn_background_color'=>array(
					'type'=>'color',
					...
					'std' => '#444444',
					'depends'=>array('samplefile_btn_type'=>'custom'),
				),

				'samplefile_btn_color'=>array(
					'type'=>'color',
				...
				'samplefile_btn_background_color_hover'=>array(
					'type'=>'color',
				...
				'samplefile_btn_color_hover'=>array(
					'type'=>'color',
