...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'addon_name' => 'sp_sl_category_products',
		'category'   => 'Sellacious',
		'title'      => JText::_('Category Products'),
		'desc'       => JText::_('Sellacious Category Products'),
		'attr'       => array(
			'general' => array(
				...
				'title_alignment'=>array(
					...
					'desc'=>JText::_('Set the alignment for this addon Title.'),
					'values'=>array(
