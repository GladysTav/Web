...
class SellaciousModelPaymentMethod extends SellaciousModelAdmin
{
	...
	public function save($data)
	{
		...
		if ($pk > 0)
		{
			...
			$existing_translations = $this->helper->translation->getTranslations($pk, 'sellacious_paymentmethod');
		...
		$this->helper->translation->saveTranslations($translations, $table->get('id'), 'sellacious_paymentmethod');
	...
	protected function preprocessData($context, &$data, $group = 'content')
	{
		if (is_object($data))
		{
			...
			if ($data->id)
			{
				$data->translations = $this->helper->translation->getTranslations($data->id, 'sellacious_paymentmethod');

				$this->helper->translation->translateRecord($data, 'sellacious_paymentmethod');
			}
		}
