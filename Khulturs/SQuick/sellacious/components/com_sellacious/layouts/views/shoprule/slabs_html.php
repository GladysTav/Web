...
$ruleTitle = $this->state->get('shoprule.title', 'shop-slabs');
?>
<?php if (count($slabs) > 0): ?>
	<a style="position:fixed; margin: 10px;"
	   href="<?php echo JRoute::_('index.php?option=com_sellacious&view=shoprule&layout=slabs&tmpl=component&format=csv') ?>"
