...
<ul id="sparks" class="pull-right report-summary">
	...
	<li class="sparks-info span-0">
		<h5>
			<?php echo JText::_('PLG_SYSTEM_SELLACIOUSREPORTSCART_SUMMARY_TOTAL_CART_VALUE'); ?>
			<span class="txt-color-greenDark">
				<?php echo $this->helper->currency->display($displayData['total_cart_value'], $c_currency, null); ?>
			</span>
		</h5>
	</li>
	<li class="sparks-info span-0">
		<h5>
			<?php echo JText::_('PLG_SYSTEM_SELLACIOUSREPORTSCART_SUMMARY_AVERAGE_CART_VALUE'); ?>
			<span class="txt-color-greenDark">
				<?php echo $this->helper->currency->display($displayData['average_cart_value'], $c_currency, null); ?>
			</span>
		</h5>
	</li>
	<li class="sparks-info span-0">
