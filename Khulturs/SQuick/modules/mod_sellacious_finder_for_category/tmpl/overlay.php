...
$query  = $app->getUserState('com_sellacious.products.filter.search');

$action = 'index.php?option=com_sellacious&view=products&category_id=1';
...
<div class="sella-search finder-overlay" id="sella<?php echo $module->id; ?>">
	...
	<div class="sella-category-searchwrapper">
		<div class="sella-searchbar">
			<form id="finder-for-category-search" action="<?php echo $action ?>" method="get" class="sellacious-search">
				...
				<input type="hidden" name="view" value="<?php echo $products; ?>"/>
