...
/**
 * Handler class for query form pricing
 *
 * @since   2.0.0
 */
class QueryformPriceHandler extends AbstractPriceHandler
{
	/**
	...
	{
		// Check number of query form fields?
	...
	{
		if (isset($data->seller) && is_object($data->seller))
		{
			$helper = SellaciousHelper::getInstance();
			$fields = $helper->field->getGlobalFields('queryform');

			$data->seller->query_form_global = $fields;
		}
	}
}
