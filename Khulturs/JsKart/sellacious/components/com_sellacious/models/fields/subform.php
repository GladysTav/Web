 ...
 *
 * Joomla's subform field does not have OnContentPrepareForm trigger which is why this is created.
 *
 ...
 * @since  1.7.3
 */
class SellaciousFormfieldSubform extends JFormField
{
	/**
	 * The form field type.
	 * @var    string
	...
	protected function getInput()
	{
		...
		$dispatcher->trigger('onContentPrepareForm', array($tmpl, $value));
	...
	private function loadSubFormData(Form &$subForm)
	{
		...
		for ($i = 0; $i < $c; $i++)
		{
			...
			$itemForm->parent_form_data = $this->form->getData();

			$dispatcher->trigger('onContentPrepareForm', array($itemForm, $value[$i]));
