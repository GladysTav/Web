 ...
 * @var   bool     $meter           Whether to show password strength.
 * @var   int      $threshold       Threshold for password strength.
 */
...
$attributes = array(
	...
	!$autocomplete ? 'autocomplete="off"' : 'autocomplete="' . htmlspecialchars($autocomplete, ENT_COMPAT, 'UTF-8') . '"',
