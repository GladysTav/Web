...
<?php if ($shippable): ?>
<div class="sel_billing ctech-text-center">
	<label>
		<input type="checkbox" checked="checked" name="same_as_ship" id="same_as_ship" value="1" <?php echo $shipCheck;?>>
		<?php echo JText::_("COM_SELLACIOUSOPC_BILLING_SAME_AS_SHIPPING");?>
	</label>
...
if ($shippable && (!$shipping || !$shipTo))
{
	...
	echo "<div class=\"shipping_address_form\">";
	echo "<div class=\"clearfix\"></div>";
	echo "<span class=\"address_name\"> " . JText::_("COM_SELLACIOUSOPC_CART_SHIPPING_ADDRESS") . "&nbsp;<i class='fa fa-flip-horizontal fa-truck'></i></span>";
