...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'category'   => 'Sellacious',
		'addon_name' => 'sp_sl_product_shipping',
		'title'      => JText::_('Product Shipping Cost'),
		'desc'       => JText::_('Sellacious Product Shipping Cost'),
		'attr'       => array(
			...
			'sellacious' => array(
				...
				'shipping_icon' => array(
					'type'=>'icon',
					'title'=>JText::_('Shipping Icon'),
					'desc'=>JText::_('Select an icon which will be display before shipping cost'),
					'std'   => '',
				),
				'shipping_icon_color' => array(
					'type'  => 'color',
					'title' => JText::_('Icon Color'),
					'desc'  => JText::_('Define a color for icon'),
					'std'   => '',
				),
			),
