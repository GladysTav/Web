...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'gallery',
		'addon_name' => 'sp_sl_product_gallery',
		'category'   => 'Sellacious',
		'title'      => JText::_('Product Gallery'),
		'desc'       => JText::_('Sellacious Product Gallery'),
		'attr'       => array(
			'general' => array(
			...
			'sellacious' => array(
				...
				'gallery_title' => array(
					...
					'std'   => JText::_('Product Gallery'),
				),
				'show_product_images' => array(
					'type'    => 'select',
					'title'   => JText::_('Show Product Images Also'),
					'values'  => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
				...
				'show_variant_attr'   => array(
					'type'    => 'select',
					'title'   => JText::_('Show Variant Attributes'),
					'values'  => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
				...
				'show_slide_arrow'    => array(
					'type'    => 'select',
					'title'   => JText::_('Show Navigation Arrows'),
					'values'  => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
				...
				'show_slide_dots'     => array(
					'type'    => 'select',
					'title'   => JText::_('Show Navigation Dots'),
					'values'  => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
