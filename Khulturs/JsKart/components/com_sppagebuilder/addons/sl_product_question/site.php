		...
		if ($product)
		{
			...
			if ($seller[0]->seller_uid)
			{
				...
				else
				{
					ob_start();
					?>
					<div class="moreinfo-box ctech-wrapper" >
								...
								<form action="<?php echo JUri::base(); ?>/index.php" method="post" name="questionForm"
									...
									<fieldset>
										...
										<div class="questionformarea">
											...
											<button type="button" class="ctech-btn ctech-btn-primary questionbtn" onclick="Joomla.submitform('product.saveQuestion', this.form);">
