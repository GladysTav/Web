...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'category'   => 'Sellacious',
		'addon_name' => 'sp_sl_product_reviewratings',
		'title'      => JText::_('Product Reviews & Ratings'),
		'desc'       => JText::_('Sellacious Product Reviews & Ratings'),
		'attr'       => array(
			...
			'sellacious' => array(
				...
				'show_ratings_form' => array(
					'type'   => 'select',
					'title'  => JText::_('Show Ratings Form'),
					'values' => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
				...
				'show_reviews_list' => array(
					'type'   => 'select',
					'title'  => JText::_('Show Reviews List'),
					'values' => array(
						'1' => JText::_('JYES'),
						'0' => JText::_('JNO')
					),
