...
<div class="ctech-wrapper">
    <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure', 0)); ?>" method="post"
        ...
        <div class="msl-container <?php echo $loginOpts->get('pw') ? 'msl-use-pw' : 'msl-use-otp'; ?>">
            ...
            <div class="ctech-form-group">
                <label for="modslgn-username" class=""><?php echo JText::_('MOD_LOGIN_VALUE_USERNAME'); ?></label>
            ...
            <div class="ctech-form-group">
                <label for="modslgn-passwd"
                       class="msl-password-label"><?php echo JText::_('JGLOBAL_PASSWORD'); ?></label>
				<?php if ($loginOpts->get('pw')): ?>
					<input type="password" id="modslgn-passwd" class="ctech-form-control input-small msl-password ctech-form-control-sm" autocomplete="off"
						   tabindex="0" size="18"
						   placeholder="<?php echo JText::_('MOD_SELLACIOUS_LOGIN_PLACEHOLDER_PW'); ?>"/>
				<?php else: ?>
					<input type="text" id="modslgn-passwd" class="ctech-form-control input-small msl-password ctech-form-control-sm" autocomplete="off"
             ...
             <div class="ctech-form-group">
                <button type="button" tabindex="0"
                        class="ctech-btn ctech-btn-primary ctech-rounded msl-login-button ctech-btn-sm"><?php echo JText::_('JLOGIN'); ?></button>
			 </div>

            <ul class="unstyled">
                <?php if ($allowClientRegistration) : ?>
                    <li>
                        <a href="<?php echo JRoute::_('index.php?option=com_sellacious&view=register'); ?>">
                            <?php echo JText::_('MOD_SELLACIOUS_LOGIN_REGISTER'); ?> <i class="fa fa-angle-right"></i></a>
                    </li>
                <?php endif; ?>
                <?php if ($allowSellerRegistration) : ?>
                    <li>
                        <a href="<?php echo JRoute::_('index.php?option=com_sellacious&view=seller'); ?>">
