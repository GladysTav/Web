...
<div class="mod-sellacious-relatedproducts related-carousel-layout <?php echo $class_sfx; ?>">
	<div class="related-productcarousel owl-carousel" id="related-productcarousel<?php echo $module->id; ?>">
		<?php foreach ($products AS $product):
			...
			echo JHtml::_('bootstrap.renderModal', 'modal-' . $module->id . '-' . $item->code, $sl_params);
					...
					<div class="related-product-info-box">
						<div class="related-product-title">
							<a href="<?php echo $url; ?>" title="<?php echo $item->title; ?>">
								<?php echo $item->title; ?> <?php echo $item->variant_title; ?>
							</a>
						</div>
						...
						<?php if ($displayquickviewbtn == '1'): ?>
							<a href="#modal-<?php echo $module->id; ?>-<?php echo $item->code; ?>" role="button" data-toggle="modal" class="btn btn-default btn-quick-view">
