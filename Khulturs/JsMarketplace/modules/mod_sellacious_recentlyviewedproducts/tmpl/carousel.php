				...
				<div class="recent-product-box <?php echo $splCategoryClass; ?>" data-rollover="container">
					...
					<div class="recent-product-info-box">
						...
						elseif ($seller_attr->price_display == 0)
						{
							...
							{
								$price = round($item->sales_price, 2) >= 0.01 ? $helper->currency->display($item->sales_price, $s_currency, $c_currency, true) : JText::_('MOD_SELLACIOUS_RECENTLYVIEWEDPRODUCTS_PRICE_FREE');
