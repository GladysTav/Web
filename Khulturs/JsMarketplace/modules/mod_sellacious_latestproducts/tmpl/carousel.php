...
<div class="mod-sellacious-latestproducts latest-carousel-layout <?php echo $class_sfx; ?>">
	<?php if ($section_title): ?>
		<h3 class="latestproducts-heading"><?php echo $section_title; ?></h3>
	<?php endif; ?>
	<?php if ($section_desc): ?>
		<p class="latestproducts-subheading"><?php echo $section_desc; ?></p>
	<?php endif; ?>
	<div class="latest-productcarousel owl-carousel" id="latest-productcarousel<?php echo $module->id; ?>">
		<?php foreach ($products AS $product):
			...
			$prodHelper  = new \Sellacious\Product($product->id, $product->variant_id, $product->seller_uid);
				...
				<div class="latest-product-box <?php echo $splCategoryClass; ?>" data-rollover="container">
					...
					<div class="latest-product-info-box">
						...
						elseif ($seller_attr->price_display == 0)
						{
							...
							{
								$price = round($item->sales_price, 2) >= 0.01 ? $helper->currency->display($item->sales_price, $s_currency, $c_currency, true) : JText::_('MOD_SELLACIOUS_LATESTPRODUCTS_PRICE_FREE');
						...
						<?php if ($displayquickviewbtn == '1'): ?>
							<a href="#modal-<?php echo $module->id; ?>-<?php echo $code; ?>" role="button" data-toggle="modal" class="btn btn-default btn-quick-view">
