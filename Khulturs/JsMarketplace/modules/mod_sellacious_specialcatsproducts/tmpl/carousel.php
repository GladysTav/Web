				...
				<div class="special-product-box <?php echo $splCategoryClass; ?>" data-rollover="container">
					...
					<div class="special-product-info-box">
						...
						elseif ($seller_attr->price_display == 0)
						{
							...
							{
								$price = round($item->sales_price, 2) >= 0.01 ? $helper->currency->display($item->sales_price, $s_currency, $c_currency, true) : JText::_('MOD_SELLACIOUS_SPECIALCATSPRODUCTS_PRICE_FREE');
