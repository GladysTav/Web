...
<div class="mod-sellacious-offeredproducts style-1 <?php echo $class_sfx; ?>">
	<div class="titlearea">
		<h3><?php echo $modtitle; ?></h3>
	</div>
	<div class="row nomargin">
		<?php if (!empty($mainProduct)) : ?>
			<div class="col-sm-12 col-md-8 nopadd">
		...
		{
			$mainexist 		= 'col-sm-12 col-md-4 nopadd';
			$innerprods 		= 'col-md-12 col-sm-6 col-xs-6 col-xxs-12 nopadd';
		} else{
			$mainexist 		= 'col-sm-12 nopadd';
			$innerprods		= 'col-xxs-12 col-xs-6 nopadd';
		}
		?>
