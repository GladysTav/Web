    ...
    <div id="acym__welcome" class="acym__content">
        ...
        <div class="grid-x margin-bottom-0">
            ...
            <?php if (empty($data['welcomeMails']) && empty($data["search"])){ ?>
                <h1 class="cell text-center acym__listing__empty__title"><?php echo acym_translation_sprintf('ACYM_NO_TEMPLATE', strtolower(acym_translation('ACYM_WELCOME_MAIL'))); ?><a href="<?php echo acym_completeLink('mails&task=edit&step=editEmail&type=welcome&type_editor=acyEditor') ?>"> <?php echo acym_translation('ACYM_CREATE_ONE') ?></a></h1>
            <?php }else{ ?>
