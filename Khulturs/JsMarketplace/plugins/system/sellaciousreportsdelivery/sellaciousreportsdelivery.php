...
/**
 * Delivery report plugin of Sellacious Report
 *
 * @since  1.7.0
 */
class plgSystemSellaciousReportsDelivery extends SellaciousPlugin
{
	/**
	...
	public function onLoadHandlers($context)
	{
		if ($context == 'com_sellaciousreporting.report')
		{
			 ...
			 */
			ReportHelper::addHandler('slot', '\Sellacious\Report\SlotReport');
		}
	}
