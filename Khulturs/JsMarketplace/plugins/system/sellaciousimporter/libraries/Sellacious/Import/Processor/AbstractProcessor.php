...
abstract class AbstractProcessor
{
	...
	protected function addIndex($key, $value)
	{
		...
		$this->importer->addIndex($this->getName(), $key, $value);
	}
	 ...
	 * @param   string  $key  The lookup key
	 *
	 * @return  string  The lookup value
	 *
	 * @since   1.6.1
	 */
	...
	/**
	 * Method to evaluate the name for this class instance
	 *
	 * @return  string  The name identifier keyword
	 *
	 * @since   1.7.0
	 */
	protected function getName()
	{
		if (!$this->name)
		{
			if (preg_match('!([^\\\]+)(Processor)?$!', get_class($this), $matches))
			{
