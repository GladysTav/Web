		...
		if ($form instanceof JForm)
		{
			...
			if ($name == 'com_sellacious.product' && !$isNew && $variantEdit && $multiVariant)
			{
				...
				if (!$editCols->get('custom_product_url'))
				{
					...
					$form->removeField('custom_url_type', 'variant.params');
					$form->removeField('custom_product_url', 'variant.params');
					$form->removeField('custom_url_advanced', 'variant.params');
					$form->removeField('custom_product_menu', 'variant.params');
					$form->removeField('custom_url_append_query', 'variant.params');
				}
			}
		}
