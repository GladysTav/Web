			...
			<tr role="row" id="jform_timings_days_row_<?php echo $num; ?>" class="timingsrow">
				<td class="text-align-left">
					<label>
						...
						<input type="hidden" name="<?php echo $field['name']; ?>[<?php echo $num;?>][state]" id="<?php echo $field['fldName'] . '_' . $field['id']; ?>_<?php echo $num;?>_state" value="<?php echo $value[$num]['state'];?>">
				...
				<td>
					<label>
						<?php if ($count < 1): ?>
						<button type="button" class="btn btn-primary <?php echo $field['fldName'] ?>-copy-all"><?php echo JText::_('PLG_SYSTEM_SELLACIOUSHYPERLOCAL_FIELD_TIMINGS_COPY_TO_ALL');?></button>
						<?php endif; ?>
					</label>
				</td>
			</tr>
