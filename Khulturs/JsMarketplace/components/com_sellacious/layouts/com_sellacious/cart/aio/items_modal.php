	...
	<table class="cart-items-table w100p">
			...
			<tr>
				...
				<td class="cart-item">
					...
					<ul class="cart-item-prices">
						...
						{
							?>
							<li><?php echo $additionalPrice; ?></li>
							<?php
						}
						?>
					</ul>
			...
			<td class="text-right">
				<ul class="cart-prices">
					...
					<li>
						...
						<strong><?php echo $helper->currency->display($totals->get('items.sub_total'), $g_currency, $c_currency, true); ?></strong>
					</li>
					<?php endif; ?>
				</ul>
			</td>
		...
		<tr>
			...
			<td class="strong text-right">
				<?php if ($cart->hasShippable()): ?>
					<?php echo JText::_('COM_SELLACIOUS_ORDERS_ESTIMATED_TOTAL_PLUS_SHIPPING'); ?>
				<?php else: ?>
					<?php echo JText::_('COM_SELLACIOUS_ORDERS_ESTIMATED_TOTAL'); ?>
				<?php endif; ?>
		...
		<tr>
			<td colspan="4" class="v-top text-right">
				...
				<?php echo $helper->currency->display($round_enabled ? $totals->get('grand_total_rounded') : $totals->get('grand_total'), $g_currency, $c_currency, true); ?></span></div>
