...
?>
<div class="layout-one category-cols <?php echo $sellCats; ?>">
		...
		<div class="desc-product">
			...
			<?php if (isset($item->product_count) || isset($item->subcat_count)): ?>
				<div class="item-counts-strip">
					<div class="tip-product"><?php
						$prod_count= $item->product_count;
						if ($prod_count!=0)
						{
							echo JText::plural('COM_SELLACIOUS_CATEGORY_PRODUCT_COUNT', $item->product_count);
						}
						?></div>
					<div class="tip-category"><?php
