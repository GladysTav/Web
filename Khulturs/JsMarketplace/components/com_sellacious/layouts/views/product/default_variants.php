		...
		<tr>
			...
			<td style="width:100px;" class="nowrap">
				...
				<a href="<?php echo $link ?>">
					<button class="btn btn-primary btn-cart-sm"><?php echo strtoupper(JText::_('COM_SELLACIOUS_PRODUCT_DETAILS')); ?></button>
				</a>
				<?php if ($allow_checkout && in_array('product', $cart_pages)): ?>
				<br/>
				<button type="button" class="btn btn-warning btn-cart-sm btn-add-cart"
