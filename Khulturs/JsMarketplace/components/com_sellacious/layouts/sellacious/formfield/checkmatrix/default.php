	...
	<table class="<?php echo $field->class ?> table-striped table-bordered jff-checkmatrix">
		...
		<th>
			...
			<label class="checkbox style-0">
				<input type="checkbox" class="checkbox style-0"
					   data-column="<?php echo $field->getAttribute('name') ?>" data-row="all_checked">
				<span class="heading">Check All</span>
			</label>
		</th>
		<?php foreach ($columns as $ci => $column): ?>
			<th class="center" data-column="<?php echo $column->value ?>">
				<label class="checkbox style-0">
					<input type="checkbox" class="checkbox style-0"
						   data-column="<?php echo $column->value ?>" data-row="col_checked">
		...
		<?php foreach ($rows as $ri => $row): ?>
			<tr>
				<th data-row="<?php echo $row->value ?>">
					<label class="checkbox style-0">
						<input type="checkbox" class="checkbox style-0"
							   data-column="<?php echo $row->value ?>" data-row="row_checked">
						<span class="heading"><?php echo $row->text ?></span>
					</label>
				</th>
