...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'addon_name' => 'sp_sl_product_custom_specs',
		'category'   => 'Sellacious',
		'title'      => JText::_('Product Custom Specs'),
		'desc'       => JText::_('Sellacious Product Custom Specifications'),
		'attr'       => array(
			'general' => array(
			...
			'sellacious' => array(
				'custom_specs_title' => array(
					'type'  => 'text',
					'title' => JText::_('Box Heading'),
					'desc'  => JText::_('Type a title which will be displayed on top of box'),
					'std'   => JText::_('Custom Specifications'),
				),
				'html' => array(
					'type'        => 'textarea',
					'title'       => JText::_('COM_SPPAGEBUILDER_ADDON_RAW_HTML_HTML'),
					'desc'        => JText::_('COM_SPPAGEBUILDER_ADDON_RAW_HTML_HTML_DESC'),
					'placeholder' => '&lt;p&gt;Insert raw html here.&lt;br&#47;&gt;Here is an example of hyper link &lt;a href=&quot;http:&#47;&#47;www.sellacious.com&quot;&gt;Sellacious&lt;&#47;a&gt;&lt;&#47;p&gt; You can use sellacious field id to show its value syntax: {label_id=1}  OR  {field_id=1}',
				),
			),
		),
	)
