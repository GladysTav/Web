...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'addon_name' => 'sp_sl_category_subcategories',
		'category'   => 'Sellacious',
		'title'      => JText::_('Category Sub Categories'),
		'desc'       => JText::_('Sellacious Category Sub Categories'),
		'attr'       => array(
			'general' => array(
			...
			'sellacious' => array(
				'showpcount' => array(
					'type'    => 'select',
					'title'   => JText::_('Show Products Count'),
					'desc'    => JText::_('Please Choose YES if you want to display Product Count.'),
					'values'  => array(
						'0' => JText::_('No'),
						'1' => JText::_('Yes'),
					),
				...
				'showccount' => array(
					'type'    => 'select',
					'title'   => JText::_('Show Child Category Count'),
					'desc'    => JText::_('Please Choose YES if you want to display Child Category Count.'),
					'values'  => array(
						'0' => JText::_('No'),
						'1' => JText::_('Yes'),
					),
