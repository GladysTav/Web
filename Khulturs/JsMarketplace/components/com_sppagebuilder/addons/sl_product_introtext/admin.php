...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'addon_name' => 'sp_sl_product_introtext',
		'category'   => 'Sellacious',
		'title'      => JText::_('Product Introtext'),
		'desc'       => JText::_('Sellacious Product Description'),
		'attr'       => array(
			'general' => array(
			...
			'sellacious' => array(
				...
				'introtext_bordercolor' => array(
					'type'  => 'color',
					'title' => JText::_('Introtext Border Color'),
					'desc'  => JText::_('Define a border color of Introtext'),
					'std'   => '',
				),
				'introtext_bgcolor' => array(
					'type'    => 'color',
					'title'   => JText::_('Background color'),
					'desc'    => JText::_('Select a background-color of Introtext'),
					'std'   => '',
				),
			),
		),
