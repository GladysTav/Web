...
class SppagebuilderAddonSL_Product_Images extends SppagebuilderAddons
{
	...
	public function render()
	{
		...
		$product_border = (isset($this->addon->settings->product_border) && $this->addon->settings->product_border) ? $this->addon->settings->product_border : 'true';
		$product_border_width = (isset($this->addon->settings->product_border_width) && $this->addon->settings->product_border_width) ? $this->addon->settings->product_border_width : '6';
		$product_border_color = (isset($this->addon->settings->product_border_color) && $this->addon->settings->product_border_color) ? $this->addon->settings->product_border_color : 'rgba(241, 241, 241, 1)';
		...
		if ($product)
		{
			...
			<style>
				...
				if ($product_border == 'true'): ?>
					.productdetail-img {
						border-style: solid;
						border-width: <?php echo $product_border_width; ?>px;
						border-color: <?php echo $product_border_color; ?>;
					}
				<?php endif; ?>
