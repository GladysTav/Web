...
SpAddonsConfig::addonConfig(
	array(
		'type'       => 'content',
		'addon_name' => 'sp_sl_category_specs',
		'category'   => 'Sellacious',
		'title'      => JText::_('Category Specifications'),
		'desc'       => JText::_('Sellacious Category Specifications'),
		'attr'       => array(
			'general' => array(
