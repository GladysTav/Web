...
use Sellacious\Cache\SpecificationRange as SpecificationRangeCache;
...
class SellaciousCacheCli extends SellaciousCliApplication
{
	...
	protected function start()
	{
		...
		$fCache = new SpecificationRangeCache;
		...
		$this->out('Specifications range cache rebuild started...');
		$fCache->build();
		$this->out('Specifications range cache rebuild finished.');
