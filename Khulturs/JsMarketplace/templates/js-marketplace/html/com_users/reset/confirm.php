...
<div class="reset-confirm<?php echo $this->pageclass_sfx; ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.confirm'); ?>" method="post" class="confirm login-form box-shadow form-validate form-horizontal well">
