...
<h4><?php echo JText::_('LOGIN_PAGE_WELCOME_TITLE')?></h4>
	<div class="login-other"><span>New member? <a href="<?php echo JRoute::_('index.php?option=com_sellacious&view=register');?>">Register</a> here.</span></div>

</div>

	<div class="d-flex login-form box-shadow ">
	<div class="col-md-9 col-sm-12 main-form-box">
		<div class="login item-title" >
			...
			<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="log-f form-validate">
            ...
            <div class="form-group">
		     ...
		     <div class="form-group">
                ...
                <div class="d-flex justify-content-between align-items-center">
					<div class="form-group js-hidden-lg">
						<div class="controls">
					...
					<div class="form-check form-group d-flex justify-content-end">
						<label class="checkbox-ui-box">
							<input id="remember" type="checkbox" name="remember" class="checkbox" value="yes">
							<span class="remme"><?php echo JText::_('COM_USERS_LOGIN_REMEMBER_ME') ?></span>
                ...
                <button type="submit" class="js-hidden-sm w-100 btn btn-primary login-btn "><?php echo JText::_('JLOGIN'); ?></button>
			</form>
		</div>
		<div class="form-links">
			<ul class="list-group mt-3 forgot-links">
		...
		<div class="col-md-3 col-sm-12 other-login-box">
			<div class="d-flex justify-content-between align-items-center">
				<div class="form-group w-100">
					<div class="controls js-hidden-sm">

					</div>
					<div class="social-login">
						<?php echo renderSocialLoginButtons(); ?>
					</div>
				</div>
