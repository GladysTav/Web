...
?>
<div class="mod-sellacious-relatedproducts related-gridtwo-layout <?php echo $class_sfx; ?>">
    <?php foreach ($products AS $product):
        ...
        <div class="related-product-wrap-gridtwo">
            <div class="related-product-box  bg-white <?php echo $splCategoryClass; ?>" data-rollover="container">
                <div class="image-box">
					<span class="product-img" style="background-image:url(<?php echo reset($images); ?>)"></span>
					<div class="product-images">
						<ul class="product-images-block">
			                <?php foreach ($images as $image): ?>
								<li class="product-images-list" style="background-image:url(<?php echo ($image) ?>);" data-image="<?php echo $image; ?>"></li>
			                <?php endforeach; ?>
						</ul>
					</div>
                        ...
                        <div class="product-action-btn">
                            <?php if ($allow_checkout && $seller_attr->price_display == 0): ?>
                                <?php if ((int) $seller_attr->stock_capacity > 0): ?>
                                    <?php if ($displayaddtocartbtn == '1' && in_array('products', $cart_pages)): ?>
                                        <button  title="<?php echo JText::_('MOD_SELLACIOUS_RELATEDPRODUCTS_ADD_TO_CART'); ?>" type="button" class="btn hasTooltip btn-add-cart add" data-item="<?php echo $item->code; ?>">
                                    ...
                                    <?php if ($displaybuynowbtn == '1' && in_array('products', $buynow_pages)): ?>
                                        <button title="<?php echo JText::_('MOD_SELLACIOUS_RELATEDPRODUCTS_BUY_NOW'); ?>" type="button" class="btn hasTooltip btn-add-cart buy" data-item="<?php echo $item->code; ?>" data-checkout="true">
                                ...
                                <?php endif; ?>
                                <?php if ($displayquickviewbtn == '1' && in_array('products', $show_modal)): ?>
                                    <a title=" <?php echo JText::_('MOD_SELLACIOUS_RELATEDPRODUCTS_QUICK_VIEW'); ?>" href="#modal-<?php echo $item->code; ?>" role="button" data-toggle="modal" class="btn hasTooltip btn-quick-view">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                <?php endif; ?>

                                <?php if ($compare_allow && $displaycomparebtn == '1' && in_array('products', $compare_pages)): ?>
                                    <label title="<?php echo JText::_('MOD_SELLACIOUS_RELATEDPRODUCTS_COMPARE'); ?>" class="product-compare btn hasTooltip">
