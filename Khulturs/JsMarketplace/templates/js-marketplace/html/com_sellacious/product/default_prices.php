...
{
	?>
    <div class="js-hidden-sm table-bulk text-center">
        <h5 class="bulk-heading text-left"><?php echo JText::_('COM_SELLACIOUS_PRODUCT_PRICE_OFFER'); ?></h5>
	<table class="w100p price-list table-bordered">
		<?php
		foreach ($prices as $price)
		{
			...
			<tr>
				...
				<td class="nowrap prices-display"><?php
    ...
    <div class="tab-box-slider-bulkprice price-list tab-bulkpriceing tab-box-slideup">
...
<script>
    jQuery(function($){
        $(".bulk-icon").click(function(){
            $(".tab-box-slider-bulkprice").slideToggle("slow");
        });
        $(".share-close").click(function(){
            $(".tab-box-slider-bulkprice").hide("slow")
        });
