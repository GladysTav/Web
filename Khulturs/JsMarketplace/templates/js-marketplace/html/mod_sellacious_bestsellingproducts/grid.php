...
<div  class="mod-sellacious-bestsellingproducts bestsellingproducts-grid-layout <?php echo $class_sfx; ?>">
	<h2 class="mod-best-heading">Best selling products</h2>
	<?php foreach ($products AS $product):
       ...
       echo JHtml::_('bootstrap.renderModal', 'qv-modal-' . $code, $sl_params);
		...
		<script>
			jQuery(document).ready(function ($) {
				...
				$('.modal[id^="qv-modal-"]').appendTo('body');
			});
		</script>
                   ...
                   <?php  $allow_checkout = $helper->config->get('allow_checkout');
                    ...
                    <div class="product-action-btn">
                        <?php if ($allow_checkout && $seller_attr->price_display == 0): ?>
                            ...
                            <?php else: ?>
                                <button class="hasTooltip  btn lbl-no-stock btn-primary">
                                    <?php echo JText::_('MOD_SELLACIOUS_BESTSELLINGPRODUCTS_OUT_OF_STOCK'); ?>
                                </button>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <?php if ($displayquickviewbtn == '1'): ?>
                                                    ...
                                                    <a  title="<?php echo JText::_('COM_SELLACIOUS_PRODUCT_QUICK_VIEW'); ?>"  href="#qv-modal-<?php                            echo $code; ?>" role="button" data-toggle="modal" class="btn  hasTooltip btn-quick-view">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                        <?php endif; ?>

                        <?php if ($compare_allow && $displaycomparebtn == '1'): ?>
                            <label title="<?php echo JText::_('COM_SELLACIOUS_PRODUCT_COMPARE'); ?>" class="product-compare btn">
	...
	<div class="text-center">
		<a class="btn btn-bestselling" href="index.php?option=com_sppagebuilder&view=page&layout=edit&id=14">View More</a>
	</div>
</div>
