...
JHtml::_('stylesheet', 'mod_breadcrumbs/style.css', null, true);

?>
<div class="mybredcrmb">
<ul itemscope itemtype="https://schema.org/BreadcrumbList" class="breadcrumb<?php echo $moduleclass_sfx; ?>">
	...
	foreach ($list as $key => $item) :
		...
		<?php elseif ($show_last) :
			...
			<li  itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="last-item active">
				<span itemprop="name">
					<?php echo $item->name; ?>
				</span>
				<meta itemprop="position" content="<?php echo $key + 1; ?>">
