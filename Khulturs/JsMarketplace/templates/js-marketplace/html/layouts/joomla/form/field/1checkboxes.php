...
<fieldset id="<?php echo $id; ?>" class="<?php echo trim($class . ' checkboxes'); ?>"
	...
	<?php foreach ($options as $i => $option) : ?>
		...
		<label for="<?php echo $oid; ?>" class="checkbox-ui-box">
...
<!--    <input type="checkbox" name="filter[hide_out_of_stock]" id="filter_hide_out_of_stock" value="1" onclick="this.form.submit();">-->
<!--    Hide Out of Stock                <span class="checkmark-checkbox"></span>-->
<!--</label>-->