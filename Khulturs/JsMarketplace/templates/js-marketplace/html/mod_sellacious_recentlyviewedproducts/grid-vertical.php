...
?>
<div class="mod-sellacious-recentviewedproducts recent-list-two-layout <?php echo $class_sfx; ?>">
    <?php foreach ($products AS $product):
        ...
        <div class="recent-product-wrap-list-two">
            <div class="recent-product-box <?php echo $splCategoryClass; ?>" data-rollover="container">
                <div class="image-box">
                    <a href="<?php echo $url; ?>">
                    <span class="product-img bgrollover" style="background-image:url(<?php echo reset($images); ?>)"
                ...
                <div class="recent-product-info-box">
                    ...
                    if (($seller_attr->price_display == 0 || $displayquickviewbtn == '1') && !($login_to_see_price && $me->guest)): ?>
                        <div class="product-action-btn">
                            <?php if ($allow_checkout && $seller_attr->price_display == 0): ?>
                                <?php if ((int) $seller_attr->stock_capacity > 0): ?>
                                    ...
                                    <?php if ($displaybuynowbtn == '1'): ?>
                                        <button type="button" class="btn btn-info btn-add-cart buy" data-item="<?php echo $code; ?>" data-checkout="true">
                            ...
                            <?php if ($displayquickviewbtn == '1'): ?>
                                <a href="#modal-<?php echo $code; ?>" role="button" data-toggle="modal" class="btn btn-outline-dark btn-quick-view">
                    ...
                    <?php if ($compare_allow && $displaycomparebtn == '1'): ?>
                        <label class="product-compare btn btn-dark"><?php echo JText::_('MOD_SELLACIOUS_RECENTLYVIEWEDPRODUCTS_COMPARE'); ?>
