			...
			<div class="special-product-box <?php echo $splCategoryClass; ?>" data-rollover="container">
				...
				<div class="special-product-info-box">
					...
					if (($seller_attr->price_display == 0 || $displayquickviewbtn == '1') && !($login_to_see_price && $me->guest)): ?>
						<div class="product-action-btn">
							<?php if ($allow_checkout && $seller_attr->price_display == 0): ?>
								<?php if ((int) $seller_attr->stock_capacity > 0): ?>
									<?php if ($displayaddtocartbtn == '1'): ?>
										<button type="button" class="btn btn-warning btn-add-cart add" data-item="<?php echo $code; ?>">
									...
									<?php if ($displaybuynowbtn == '1'): ?>
										<button type="button" class="btn btn-dark btn-add-cart buy" data-item="<?php echo $code; ?>" data-checkout="true">
							...
							<?php if ($displayquickviewbtn == '1'): ?>
								<a href="#modal-<?php echo $code; ?>" role="button" data-toggle="modal" class="btn btn-dark btn-quick-view">
					...
					<?php if ($compare_allow && $displaycomparebtn == '1'): ?>
						<label class="product-compare btn btn-dark"><?php echo JText::_('MOD_SELLACIOUS_SPECIALCATSPRODUCTS_COMPARE'); ?>
