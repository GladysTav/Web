...
(function ($) {
	...
	$.smallBox = function (settings, callback) {
		...
		if (settings.title == 'Success')
		{
			holderIcon = 'fa fa-check-circle';
		}
		else if (settings.title == 'Warning')
		{
			holderIcon = 'fa fa-exclamation';
		}
		else if (settings.title == 'Error')
		{
			holderIcon = 'fa fa-times';
		}
		else
		{
			holderIcon = 'fa fa-check-circle';
		...
		if (settings.icon == undefined) {
			BoxSmall = "<div id='smallbox" + SmallBoxes + "' class='SmallBox animated fadeInRight fast'>" +
							"<div class='colorHolder'>" +
								"<i class='" + holderIcon + "'></i>" +
							"</div>" +
							"<div class='textoFull'>" +
		...
		if (settings.color == undefined) {
			...
			ThisSmallBox.find('.colorHolder').css("background-color", settings.color);
		}
