...
class SellaciousHelperVariant extends SellaciousHelperBase
{
	 ...
	 * @since   1.2.0
	 */
	public function getSpecifications($variant_id, $fields = null, $full_field = false, $language = null)
	{
	 ...
	 * @since   1.2.0
	 */
	public function getProductSpecifications($product_id, $fields = null, $full_field = false, $language = null)
	{
