...
class SellaciousHelperField extends SellaciousHelperBase
{
	...
	*/
	 ...
	 * @since   1.5.3
	 */
	public function getFieldsXml($pks, $group = null, $fieldsetName = null, $fieldsetLabel = null, $language = null)
	{
		$items = array();
		$forms = array();
	 ...
	 * @since   1.0.0
	 */
	public function createFormXml($fields, $fieldset, $group = null, $label = null, $language = null)
	{
		...
		if (!empty($fields))
		{
			foreach ($fields as $field)
			{
				$this->addXmlElement($field, $parent, $language);
			}
		}
