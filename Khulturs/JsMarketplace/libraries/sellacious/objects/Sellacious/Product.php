...
class Product extends BaseObject
{
	...
	public function getSpecifications($grouped = true, $fieldTypes = array('core', 'variant'), $valueOnly = false)
	{
		if (!isset($this->specifications))
		{
			...
			$field_ids  = $this->helper->category->getFields($categories, $fieldTypes);
	...
	public function getPrices($seller_uid, $quantity = null, $client_catid = null)
	{
		...
		foreach ($prices as $iPrice)
		{
			...
			$this->helper->translation->translateValue($iPrice->client_catid, 'sellacious_categories', 'title', $iPrice->client_category, $language);
		}
