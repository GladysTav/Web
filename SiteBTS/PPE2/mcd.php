...
<body><div id="body" class="width">
    <section id="content" class="two-column with-right-sidebar">
      <article>
        <div style="margin-left:1em; margin-top:2em;"><br>
<h2>Application de notation de repas</h2><br>
<h3>Modèle conceptuel de données :</h3>
<img src="MCD.jpg">
            ...
            <ul>  
               <li>
                  <ul class="blocklist">
                    ...
                    <li><a class="selected" href="mcd.php">MCD</a></li>
                    <li><a href="mld.php">MLD</a></li>
                    <li><a href="notice.php">Notice utilisateur</a></li>
                   </ul>
                </li>
            </ul>
            </aside>
